            ...
            <div class="row">
                ...
                <table id="demo-custom-toolbar"  data-toggle="table"
                    ...
                    <tr id="banner_{{ $n }}">
                            <td>{{ $n }}</td>
                            <td>
                                @if($nosban != $n)<button style="background: none; border: none;" onclick="ChangeOrder({{ $banner->orderset }},'down','{{ url('admin/banners')}}/')"><i class="fa fa-arrow-down"></i></button> @endif
                                @if($n > 1)<button style="background: none; border: none;" onclick="ChangeOrder({{ $banner->orderset }},'up','{{ url('admin/banners')}}/')"><i class="fa fa-arrow-up"></i></button> @endif
                            </td>
