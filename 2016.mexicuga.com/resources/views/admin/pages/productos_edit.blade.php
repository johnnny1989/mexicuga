...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="card-box">
            ...
            <form class="form-horizontal" id="basic-form" role="form" enctype="multipart/form-data" method="POST" action="{{ url('admin/productos_edit') }}" accept-charset="UTF-8">
                {!! csrf_field() !!}
                    ...
                    <section>
                        <div class="col-md-6">
                            ...
                            <div class="radio radio-success">
                                <input type="radio" name="producttype" id="radio14" @if($product->producttype == 'Mexicuga') checked=""  @endif value="Mexicuga" >
                                <label for="radio14"> Mexicuga</label>
                            </div>
                            <div class="radio radio-success">
                                <input type="radio" name="producttype" id="radio19" @if($product->producttype == 'Mexicuga_Familia') checked=""  @endif value="Mexicuga_Familia">
                                <label for="radio19"> Mexicuga Familia</label>
                            </div>
                            <div class="radio radio-success">
                                <input type="radio" name="producttype" id="radio18" @if($product->producttype == 'MexiPuntos') checked=""  @endif value="MexiPuntos">
                        ...
                        <div class="col-md-6">
                            <h4>Mostrar como</h4>
                            <div class="radio radio-success">
                                <input type="radio" name="showas" id="lo_nuevo" value="Producto_Normal" @if($product->showas == 'Producto_Normal') checked=""  @endif>
                                <label for="lo_nuevo"> Producto Normal</label>
                            </div>
                            <div class="radio radio-success">
                                <input type="radio" name="showas" id="lo_nuevo" value="Lo_Nuevo" @if($product->showas == 'Lo_Nuevo') checked=""  @endif>
                                <label for="lo_nuevo"> Lo Nuevo</label>
                            </div>
                            <div class="radio radio-success">
                                <input type="radio" name="showas" id="oferta" value="Oferta" @if($product->showas == 'Oferta') checked=""  @endif>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group clearfix">
                                ...
                                <div class="col-lg-4">
                                    <select class="form-control" id="LisUni" name="department">
                                        ...
                                        <option @if($product->department_id == $vals->id) selected=""  @endif value="{{ $vals->id }}">{{ $vals->department }}</option>
                                        @endforeach
                            ...
                            <div class="form-group clearfix">
                                ...
                                <div class="col-lg-4">
                                    <select class="form-control" name="category" id="filtro1" onchange="crgCat();">
                                        ...
                                        <option @if($product->category_id == $vals->id) selected=""  @endif value="{{ $vals->id }}">{{ $vals->category }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="form-group clearfix">
                                ...
                                <div class="col-lg-4">
                                    <select class="form-control" id="LisUni" name="brand">
                                        ...
                                        <option @if($product->brand_id == $vals->id) selected=""  @endif value="{{ $vals->id }}">{{ $vals->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group clearfix">
                                ...
                                <div class="col-lg-4">
                                    <select class="form-control" id="LisUni" name="availability">
                                        <option @if($product->availability == 1) selected=""  @endif value="0">En Existencia</option>
                                        <option @if($product->availability == 2) selected=""  @endif value="1">Sujeto a Disponibilidad</option>
                                        <option @if($product->availability == 3) selected=""  @endif value="2">Preguntar por Existencia</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group clearfix">
                                ...
                                <div class="col-lg-2{{ $errors->has('includes') ? ' has-error' : '' }}">
                                    <input class="form-control required" value="{{ old('includes')?old('includes'):$product->includes }}" id="includes" name="includes" type="text">
                                ...
                                <div class="col-lg-3{{ $errors->has('code') ? ' has-error' : '' }}">
                                    <input class="form-control required" value="{{ old('code')?old('code'):$product->code }}" id="userName" name="code" type="text">
                            ...
                            <div class="form-group clearfix">
                                ...
                                <div class="col-lg-10{{ $errors->has('userName') ? ' has-error' : '' }}">
                                    <input class="form-control required" value="{{ old('userName')?old('userName'):$product->userName }}" id="userName" name="userName" type="text">
                            ...
                            <div class="form-group clearfix">
                                <span id="appendForm">
                               <?PHP  $x = old('noofinput')?old('noofinput'):count($productprice); ?>
                                ...
                                <div class="row" id="price_row_{{ $n }}">
                                    ...
                                    <div class="col-lg-4{{ $errors->has('measures_'.$n) ? ' has-error' : '' }}">
                                        <input class="form-control required" value="{{ old('measures_'.$n)?old('measures_'.$n):$productprice[$n-1]->measures }}" id="measures_{{ $n }}" name="measures_{{ $n }}" type="text">
                                    ...
                                    <div class="col-lg-2{{ $errors->has('normalprice_'.$n) ? ' has-error' : '' }}">
                                        <input class="form-control required" value="{{ old('normalprice_'.$n)?old('normalprice_'.$n):$productprice[$n-1]->normal_price  }}" id="normalprice_{{ $n }}" name="normalprice_{{ $n }}" type="text" placeholder="0.00">
                                    ...
                                    <div class="col-lg-2{{ $errors->has('discount_'.$n) ? ' has-error' : '' }}">
                                        <input class="form-control required" value="{{ old('discount_'.$n)?old('discount_'.$n):$productprice[$n-1]->discount }}" id="discount_{{ $n }}" name="discount_{{ $n }}" type="text" placeholder="0%">
                                    ...
                                    <div class="col-lg-2{{ $errors->has('publicprice_'.$n) ? ' has-error' : '' }}">
                                        <input class="form-control required" value="{{ old('publicprice_'.$n)?old('publicprice_'.$n):$productprice[$n-1]->public_price }}" id="publicprice_{{ $n }}" name="publicprice_{{ $n }}" type="text" placeholder="0.00">
                            ...
                            <div class="form-group clearfix">
                                ...
                                <div class="col-lg-4">
                                    <select class="form-control" id="LisUni" name="salesunit">
                                        ...
                                        <option @if($product->salesunit == $vals->id) selected=""  @endif value="{{ $vals->id }}">{{ $vals->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <label class="col-lg-2 control-label " for="confirm">Color</label>
                                <div class="col-lg-4{{ $errors->has('color') ? ' has-error' : '' }}">
                                    <input class="form-control required" value="{{ old('color')?old('color'):$product->color }}" name="color" type="text">
                            ...
                            <div class="form-group clearfix">
                                ...
                                <div class="col-lg-2{{ $errors->has('alto') ? ' has-error' : '' }}">
                                    <input class="form-control required" value="{{ old('alto')?old('alto'):$product->alto }}" name="alto" type="text">
                                ...
                                <div class="col-lg-2{{ $errors->has('width') ? ' has-error' : '' }}">
                                    <input class="form-control required" value="{{ old('width')?old('width'):$product->width }}" name="width" type="text">
                            ...
                            <div class="form-group clearfix">
                                ...
                                <div class="col-lg-2{{ $errors->has('long') ? ' has-error' : '' }}">
                                    <input class="form-control required" value="{{ old('long')?old('long'):$product->long }}" name="long" type="text">
                                ...
                                <div class="col-lg-2{{ $errors->has('Weight') ? ' has-error' : '' }}">
                                    <input class="form-control required" value="{{ old('Weight')?old('Weight'):$product->Weight }}" name="Weight" type="text">
                            ...
                            <div class="form-group clearfix">
                                ...
                                <div class="col-lg-10{{ $errors->has('additional_information') ? ' has-error' : '' }}">
                                    <textarea class="form-control" name="additional_information">{{ old('additional_information')?old('additional_information'):$product->additional_information }}</textarea>
                            ...
                            <div class="form-group clearfix">
                                ...
                                <div class="col-lg-2{{ $errors->has('deleveryfrom') ? ' has-error' : '' }}">
                                    <input class="form-control required" value="{{ old('deleveryfrom')?old('deleveryfrom'):$product->deleveryfrom }}" name="deleveryfrom" type="text">
                                ...
                                <div class="col-lg-2{{ $errors->has('deleveryto') ? ' has-error' : '' }}">
                                    <input class="form-control required" value="{{ old('deleveryto')?old('deleveryto'):$product->deleveryto }}" name="deleveryto" type="text">
                            ...
                            <div class="form-group clearfix">
                                ...
                                <div class="col-lg-10{{ $errors->has('deleverycondition') ? ' has-error' : '' }}">
                                    <textarea class="form-control" name="deleverycondition">{{ old('deleverycondition')?old('deleverycondition'):$product->deleverycondition }}</textarea>
                            ...
                            <div class="form-group clearfix">
                                ...
                                <div class="col-lg-4">
                                    <select id="LisProv" name="provider" class="form-control valid" aria-invalid="false">
                                        ...
                                        <option @if($product->provider_id == $vals->id) selected=""  @endif value="{{ $vals->id }}">{{ $vals->company }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="form-group clearfix">
                                ...
                                <div class="col-lg-4">
                                    <select id="LisCata" name="catalogue" class="form-control valid" aria-invalid="false">
                                        ...
                                        <option @if($product->catalogue_id == $vals->id) selected=""  @endif value="{{ $vals->id }}">{{ $vals->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <label class="col-lg-2 control-label " for="confirm">No. Página</label>
                                <div class="col-lg-3{{ $errors->has('nopage') ? ' has-error' : '' }}">
                                    <input class="form-control" value="{{ $product->nopage or old('nopage') }}" name="nopage" type="text">
                    ...
                    <section>
                        <div class="form-group clearfix">
                            ...
                            <div class="col-lg-10{{ $errors->has('productcode') ? ' has-error' : '' }}">
                                <textarea class="form-control" name="productcode" placeholder="Ej. 0015, 5487, 6598, 3215">{{ old('productcode')?old('productcode'):$product->productcode }}</textarea>
                        ...
                        <div class="form-group clearfix">
                            <div class="col-md-6">
                                ...
                                <div class="form-group{{ $errors->has('mainimage') ? ' has-error' : '' }}">
                                    <input type="file" accept="image/*" onchange="ImagePreview(this.files[0],'primeimage','filemsg')" value="" name="mainimage">
                                ...
                                <img src="{{ asset('public/images/product/'.$primeimage->imagename ) }}" id="primeimage" style="max-height: 250px; max-width: 250px;" class"img-responsive">
                            </div>
                            <div class="col-md-6">
                                <h4>Galería</h4>
                                <div class="form-group{{ $errors->has('files') ? ' has-error' : '' }}">
                                    <input type="file" accept="image/*" class="filestyle" id="files" name="files[]" value="" multiple>
                                ...
                                <output style="padding: 0">
                                    ...
                                    <div id="ImgId_{{ $img->id }}" class="col-lg-4col-xs-4 col-sm-4 col-md-4 col-lg-4">
                                        <img class="thumb" src="{{ asset('public/images/product/gallery/'.$img->imagename ) }}" style="max-height:145px; max-width:145px; margin:3px;">
                                        <div class="clearfix"></div>
                                        <span class="btn btn-small" style="padding: 0; color: #F01;" onclick="RemoveGalleryImg({{ $img->id }})"><small>Remove</small></span>
                                    </div>
                                    @endforeach
                                </output>
                                <output id="list" style="padding: 0;"></output>
                                </div>                               
                            </div>
                        </div>
                    </section>
                    ...
                    <section>
                        <div class="form-group clearfix">
                            ...
                            <div class="col-lg-10{{ $errors->has('keywords') ? ' has-error' : '' }}">
                                <textarea class="form-control" name="keywords" placeholder="Ej. martillo, martillo truper, martillo construcción, martillo construccion">{{ old('keywords')?old('keywords'):$product->keywords }}</textarea>
