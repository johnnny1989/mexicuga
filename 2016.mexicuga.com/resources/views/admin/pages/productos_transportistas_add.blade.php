...
<div class="row">
    <div class="col-sm-12">
        <h1 class="page-title">Agregando transportista</h1>
        <ol class="breadcrumb">
            <li>
...
<div class="row">
    <div class="col-md-12 alert" id="transportmsg" style="display: none;"></div>
        <div class="col-md-4">
        <form class="form-horizontal" id="transportForm" role="form" enctype="multipart/form-data" method="POST" action="{{ url('admin/productos_transportistas_create') }}" accept-charset="UTF-8">
                {!! csrf_field() !!}
            <div class="card-box">
                <div class="row">
                    <div class="col-md-12">
