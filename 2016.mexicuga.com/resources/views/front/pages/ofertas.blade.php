                ...
                <div class="container">
                	<div class="row">
                		<article class="col-md-12">
                			<h1 class="ofertas"><i class="fa fa-tag"></i> Ofertas</h1>
                		</article>
                	</div>
                </div>
            </div>
                ...
                <div class="container productos_container">
 					<div class="row">
                                <div class="col-xs-6 col-sm-4 col-md-3 text-center mb-25">
                                    <article class="product light">
                                        <figure class="figure-hover-overlay" alt="ACOPLADOR RAPIDO JGO 5 PIEZAS" title="ACOPLADOR RAPIDO JGO 5 PIEZAS">
                                        	<div class="product-sale"><i class="fa fa-tag"></i> 20%</div>
                                        ...
                                        <div class="product-caption">
                                            <div class="block-name">
                                                ...
                                                <p class="tipo_precio"><span>$ 800.00</span> $ 640.00</p>
                                ...
                                <div class="col-xs-6 col-sm-4 col-md-3 text-center mb-25">
                                    <article class="product light">
                                        <figure class="figure-hover-overlay">  
                                        	<div class="product-sale"><i class="fa fa-tag"></i> 30%</div>                                                                      
                                        ...
                                        <div class="product-caption">
                                            <div class="block-name">
                                                ...
                                                <p class="tipo_precio"><span>$ 110.00</span> $ 80.00</p>
                                                <p><strong>I.V.A incluído</strong></p>
                                                <p>Código: 1620</p>
                                                <p>Entrega: 1 a 2 días hábiles</p>
                                            </div>
                                ...
                                <div class="col-xs-6 col-sm-4 col-md-3 text-center mb-25">
                                    <article class="product light">
                                        <figure class="figure-hover-overlay">
                                        	<div class="product-sale"><i class="fa fa-tag"></i> 45%</div> 
                                        ...
                                        <div class="product-caption">
                                            <div class="block-name">
                                                ...
                                                <p class="tipo_precio"><span>$ 45.00</span> $ 18.50</p>
                                                <p><strong>I.V.A incluído</strong></p>
                                                <p>Código: T19784</p>
                                                <p>Entrega: 1 a 2 días hábiles</p>
                                            </div>
                                ...
                                <div class="col-xs-6 col-sm-4 col-md-3 text-center mb-25">
                                    <article class="product light">
                                        <figure class="figure-hover-overlay">
                                        	<div class="product-sale"><i class="fa fa-tag"></i> 15%</div>                                                                        
                                        ...
                                        <div class="product-caption">
                                            <div class="block-name">
                                                ...
                                                <p class="tipo_precio"><span>$ 135.00</span> $ 103.00</p>
                                                <p><strong>I.V.A incluído</strong></p>
                                                <p>Código: 3390</p>
                                                <p>Entrega: 1 a 2 días hábiles</p>
                                            </div>
                                    ...
                                    <article class="product light">
                                        ...
                                        <div class="product-caption">
                                            <div class="block-name">
                                                ...
                                                <p class="tipo_precio"><span>$ 76.00</span> $ 58.00</p>
                                                <p><strong>I.V.A incluído</strong></p>
                                                <p>Código: 4948</p>
                                                <p>Entrega: 1 a 2 días hábiles</p>
                                            </div>
                                ...
                                <div class="col-xs-6 col-sm-4 col-md-3 text-center mb-25">
                                    <article class="product light">
                                        <figure class="figure-hover-overlay">
                                        	<div class="product-sale"><i class="fa fa-tag"></i> 10%</div>                                                                        
                                        ...
                                        <div class="product-caption">
                                            <div class="block-name">
                                                ...
                                                <p class="tipo_precio"><span>$ 56.00</span> $ 42.00</p>
                                                <p><strong>I.V.A incluído</strong></p>
                                                <p>Código: C4064</p>
                                                <p>Entrega: 1 a 2 días hábiles</p>
                                            </div>
                                ...
                                <div class="col-xs-6 col-sm-4 col-md-3 text-center mb-25">
                                    <article class="product light">
                                        <figure class="figure-hover-overlay">
                                        	<div class="product-sale"><i class="fa fa-tag"></i> 5%</div>                                                                        
                                        ...
                                        <div class="product-caption">
                                            <div class="block-name">
                                                ...
                                                <p class="tipo_precio"><span>$ 84.00</span> $ 77.00</p>
                                                <p><strong>I.V.A incluído</strong></p>
                                                <p>Código: 1627</p>
                                                <p>Entrega: 1 a 2 días hábiles</p>
                                            </div>
