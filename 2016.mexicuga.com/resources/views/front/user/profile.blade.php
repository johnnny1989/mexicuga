                        ...
                        <div class="row">
                            <div>
                                ...
                                <ul class="nav nav-tabs" role="tablist">
                                    <li role="presentation" class="active"><a href="#mi_perfil" aria-controls="home" role="tab" data-toggle="tab"><i class="fa fa-user"></i> Mi Perfil</a></li>
                                    ...
                                    <li role="presentation"><a href="#mis_pedidos" aria-controls="settings" role="tab" data-toggle="tab"><i class="fa fa-list"></i> Mis Pedidos</a></li>
                                ...
                                <div class="tab-content">
                                    <div role="tabpanel" class="tab-pane active" id="mi_perfil">
                                        <div class="row">
                                    ...
                                    <div role="tabpanel" class="tab-pane" id="info_facturacion">
                                        <form class="form-horizontal" id="UpdateBilling" role="form" method="POST" action="{{ url('/mi-perfil-billing-info') }}">
                                            ...
                                            <div class="row">
                                                ...
                                                <p class="col-md-3">* No. Ext: <input type="number" value="{{ $udtl->bill_noext }}" name="bill_noext" class="form-control"></p>
                                                <p class="col-md-3">No. Int: <input type="number" value="{{ $udtl->bill_noint }}" name="bill_noint" class="form-control"></p>
                                                ...
                                                <p class="col-md-4">* Estado: <input type="text" value="{{ $udtl->bill_state }}" name="bill_state" id="bill_state" required="required" class="form-control"></p>
                                                <p class="col-md-4">* País: <input type="text" value="{{ $udtl->bill_country }}" name="bill_country" id="bill_country" required="required" class="form-control"></p>
                                                <div class="clearfix"></div>
                                                <div class="col-md-12">
                                                    <button type="submit" class="btn btn-lg btn_verde"><i class="fa fa-floppy-o"></i> Guardar</button>
                                                </div>
                                    ...
                                    <div role="tabpanel" class="tab-pane" id="domicilio_entrega">
                                        <form class="form-horizontal" id="UpdateShipping" role="form" method="POST" action="{{ url('/mi-perfil-shipping-info') }}">
                                            ...
                                            <div class="row">
                                                ...
                                                <p class="col-md-3">* No. Ext: <input type="number" value="{{ $udtl->ship_noext }}" name="ship_noext" class="form-control"></p>
                                                <p class="col-md-3">No. Int: <input type="number" value="{{ $udtl->ship_noint }}" name="ship_noint" class="form-control"></p>
                                                ...
                                                <p class="col-md-4">* Estado: <input type="text" value="{{ $udtl->ship_state }}" name="ship_state" id="ship_state" required="required" class="form-control"></p>
                                                <p class="col-md-4">* País: <input type="text" value="{{ $udtl->ship_country }}" name="ship_country" id="ship_country" required="required" class="form-control"></p>
                                                <div class="clearfix"></div>
                                                <div class="col-md-12">
                                                    <button type="submit" class="btn btn-lg btn_verde"><i class="fa fa-floppy-o"></i> Guardar</button>
                                                </div>
                                    ...
                                    <div role="tabpanel" class="tab-pane" id="mis_pedidos">
                                        <div class="row">
