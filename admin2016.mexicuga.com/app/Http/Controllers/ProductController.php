...
//        return $request->all();
        ...
        $pro->measures        =   $request->measures_1;
        $pro->normal_price    =   $request->normalprice_1;
        $pro->public_price    =   $request->publicprice_1;
        $pro->discount        =   $request->discount_1;
        $pro->save();
...
//        }
    ...
    public function update(ProductRequest $request) {
        ...
        $pro->productcode       =   $request->productcode;
        $pro->keywords          =   $request->keywords;
        $pro->measures        =   $request->input('measures_1');
        $pro->normal_price    =   $request->input('normalprice_1');
        $pro->public_price    =   $request->input('publicprice_1');
        $pro->discount        =   $request->input('discount_1');
