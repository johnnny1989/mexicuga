                    ...
                    <section>
                        <div class="col-md-12">
                            ...
                            <div class="form-group clearfix">
                                ...
                                <div class="col-lg-4">
                                    <select class="form-control" name="category" id="filtro1" >
                                ...
                                <span id="appendForm">
                                    ...
                                    <div class="row" id="price_row_{{ $n }}">
                                        ...
                                        <div class="col-lg-2{{ $errors->has('normalprice_'.$n) ? ' has-error' : '' }}">
                                            <input onchange="PutPriceOnPublicPrice('{{ $n }}')" class="form-control required" value="{{ old('normalprice_'.$n) }}" id="normalprice_{{ $n }}" name="normalprice_{{ $n }}" type="text" placeholder="0.00">
                                        ...
                                        <div class="col-lg-2{{ $errors->has('discount_'.$n) ? ' has-error' : '' }}">
                                            <input class="form-control" value="@if(old('discount_'.$n) != ""){{ old('discount_'.$n) }}@else{{"0"}}@endif" onchange="updatePublic('{{ $n }}')" id="discount_{{ $n }}" name="discount_{{ $n }}" type="text" placeholder="0%">
                                        ...
                                        <div class="col-lg-2{{ $errors->has('publicprice_'.$n) ? ' has-error' : '' }}">
                                            <input class="form-control required" value="{{ old('publicprice_'.$n) }}" id="publicprice_{{ $n }}" name="publicprice_{{ $n }}" type="text" placeholder="0.00" onchange="updatedPublic('{{ $n }}')">
...
<script type="text/javascript">
    function PutPriceOnPublicPrice(n) {
        var normal = $("#normalprice_"+n).val();
        $("#publicprice_"+n).val(normal);
    }

    function updatePublic(n){
        var normal = $("#normalprice_"+n).val();
        var discount = $("#discount_"+n).val();
        var public1 = normal- (normal * discount)/100;
        $("#publicprice_"+n).val(public1);
    }

    function updatedPublic(n){

        var public1 = parseInt($("#publicprice_"+n).val());
        var discount = parseInt($("#discount_"+n).val());
        var normal = public1 + (public1 * discount/100);
        $("#normalprice_"+n).val(normal);
    }
