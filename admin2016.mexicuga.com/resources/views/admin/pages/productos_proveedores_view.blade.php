...
<div class="container">
    ...
    <!-- Page-Title -->
    <form action="{{ url('admin/productos_proveedores_add') }}">
        <div class="row">
            <div class="col-sm-12">
...
<div class="container">
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            @endif
            <div class="card-box">
                <h4 class="m-t-0 header-title"><b>LISTADO DE PROVEEDORES</b></h4>
                <br>
                    ...
                    <table id="demo-foo-row-toggler" class="table toggle-circle table-hover" data-page-size="50">
                        ...
                        <tbody>
                            ...
                            <tr id="provider_{{ $n }}">
                                ...
                                <td><a href="{{ url('admin/productos_proveedores_edit') }}/{{ $vals->id }}" title="Editar"><i class="fa fa-pencil type_amarilla"></i></a> <button type="button" style="background: none; border: none;" onclick="Deleteit('provider_{{ $n }}','{{ url('admin/productos_proveedores_del') }}/{{ $vals->id }}')" title="Eliminar"><i class="fa fa-times tipo_roja"></i></button></td>
                            </tr>
                            <?PHP $n++; ?>
                            @endforeach
