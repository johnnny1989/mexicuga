                ...
                <table id="demo-custom-toolbar"  data-toggle="table"
                    ...
                    <tbody>
                        ...
                        <tr id="department_{{ $n }}">
                            <td>{{ $n }}</td>
                            <td>
                                @if($nosdep != $n)<button style="background: none; border: none;" onclick="ChangeOrder({{ $department->orderset }}, 'down','{{ url('admin/departs')}}/')"><i class="fa fa-arrow-down"></i></button> @endif
                                @if($n > 1)<button style="background: none; border: none;" onclick="ChangeOrder({{ $department->orderset }}, 'up','{{ url('admin/departs')}}/')"><i class="fa fa-arrow-up"></i></button> @endif
                            </td>
