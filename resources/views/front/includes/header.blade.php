                                    ...
                                    <div class="col-md-4">
                                        <div class="top-search-form pull-left">
                                            <form id="product_search">
                                                {!! csrf_field() !!}
                                                <input type="text" id="search_value" placeholder="Buscar ..." required="required" name="Search" class="form-control">
                                                       <button type="button" id="product_search1"><i class="fa fa-search"></i></button>
                                            </form>
                                            <script>
                                                $("#product_search").submit(function(e) {
                                                    e.preventDefault();
                                                    var search_value = $("#search_value").val();
                                                    var url = "{{ url('/resultados-busquedas') }}"+"/"+search_value;
//                                                    alert(url);
                                                    location.href = url;
                                                });
                                            </script>
