                        ...
                        <div class="row">
                            <div>
                                ...
                                <ul class="nav nav-tabs" role="tablist">
                                    ...
                                    <li role="presentation" class="active"><a href="#mis_compras" aria-controls="settings" role="tab" data-toggle="tab"><i class="fa fa-check"></i> Mis Compras</a></li>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div role="tabpanel" class="tab-pane active" id="mis_compras">
                                        <div class="row">
                                            <article class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
                                                <h3>Mis Compras</h3>
                                                <div class="table-responsive">
