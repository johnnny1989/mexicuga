                        ...
                        <div class="row">
                            <div> 
                                ...
                                <ul class="nav nav-tabs" role="tablist">
                                    ...
                                    <li role="presentation" class="active"><a href="#mis_mexipuntos" aria-controls="settings" role="tab" data-toggle="tab"><i class="fa fa-circle"></i> Mis MexiPuntos</a></li>
                                </ul>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div role="tabpanel" class="tab-pane active" id="mis_mexipuntos">
                                        <div class="row">
                                            <article class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
